...
class ActionSteps extends BaseSteps {
  ...
  When("^I select (.*) and click continue$") { (option: String) =>
    option match {
      ...
      case "Authorised and Valid"                                => clickById("bank-result-2")
      case "Authorised and NotValid"                             => clickById("bank-result-3")
      case "Authorised and NotReceived"                          => clickById("bank-result-4")
      case "Canceled"                                            => clickById("bank-result-5")
      case "Failed"                                              => clickById("bank-result-6")
